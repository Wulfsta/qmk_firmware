...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_JP(
        ...
        KC_TAB, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______,
    ...
    [3] = LAYOUT_JP(
        ...
        KC_LSFT, _______, _______, _______, _______, _______, KC_DOT, KC_7, KC_8, KC_9, _______, KC_RSFT, _______, _______,
