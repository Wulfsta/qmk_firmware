...
#define ALL_LAYERS BASE_LAYER | NUMROW_LAYER | CMDKEY_LAYER | NUMPAD_LAYER
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_JP(
        ...
        KC_TAB, _______, _______, O_MINS, O_PLUS, O_EQL, _______, KC_1, KC_2, KC_3, _______, _______, _______,
